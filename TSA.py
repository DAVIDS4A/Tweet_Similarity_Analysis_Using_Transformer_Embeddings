...
train_data, test_data = train_test_split(pairs_df, test_size=0.2, random_state=42)

# Creating datasets and dataloaders
tokenizer = BertTokenizer.from_pretrained('bert-base-uncased')
train_dataset = TweetDataset(train_data['pair'], tokenizer, MAX_LENGTH)
...
for epoch in range(EPOCHS):
    ...
    for batch_idx, data in enumerate(train_dataloader):
        inputs, labels = data['input_ids'], data['attention_mask'], data['labels']
